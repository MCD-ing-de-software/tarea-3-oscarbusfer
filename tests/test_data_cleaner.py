...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_drop_invalid_rows_removes_rows_with_missing_values(self):
        ...
        self.assertEqual(result[['name','age']].isna().sum().sum(), 0, 'No debería haber valores faltantes en las columnas especificadas ')
    ...
    def test_remove_outliers_iqr_removes_extreme_values(self):
        ...
        self.assertNotIn(120, result['age'].values, 'El valor atipico debería ser eliminado')
        self.assertIn(25, result['age'].values, 'Valores normales no deberían ser eliminados')
